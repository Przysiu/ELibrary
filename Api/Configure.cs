...
namespace Api
{
        public static class Configure
    {
        ...
        {
            services
            .AddDbContext<LibraryDatabaseContext>()
        ...
        public static void ConfigureJWT(this IServiceCollection services, JwtSettings
       jwtSettings)
        {
        ...
        public static async void AddUsers(this WebApplication app)
        {
            using (var scope = app.Services.CreateScope())
            {
                ...
                var find = await userManager.FindByEmailAsync("demo@demo.wsei.edu.pl");
                if (find == null)
                {
                    UserEntity user = new UserEntity()
                    {
                        Email = "demo@demo.wsei.edu.pl",
                        UserName = "demo"
                    };
                    var saved = await userManager?.CreateAsync(user, "asdf1234@");
